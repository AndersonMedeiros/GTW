...
public class PrincipalAdm extends AppCompatActivity
    ...
    private ImageButton bt_cad_material;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_cad_material = (ImageButton)findViewById(R.id.bt_cad_material);
        bt_info = (ImageButton)findViewById(R.id.bt_info);

        bt_cad_material.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(PrincipalAdm.this, CadMaterial.class);
                startActivity(it);
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.principal_adm, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            Intent it = new Intent(PrincipalAdm.this, PrincipalAdm.class);
            startActivity(it);

        } else if (id == R.id.nav_sair) {
            Intent it = new Intent(PrincipalAdm.this, Login.class);
            startActivity(it);
        }
